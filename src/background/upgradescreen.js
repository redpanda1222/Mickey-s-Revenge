...
class UpgradeScreen {
    ...
    draw(ctx) {
        if (this.visible) {
            ...
            ctx.fillText(this.upgrade1, upgradeButtonLeft.x, upgradeButtonLeft.y , upgradeButtonDimensions.w * 0.80);
            ctx.fillText(this.upgrade2, upgradeButtonMid.x, upgradeButtonMid.y, upgradeButtonDimensions.w * 0.80);
            ctx.fillText(this.upgrade3, upgradeButtonRight.x, upgradeButtonRight.y, upgradeButtonDimensions.w * 0.80);
        }
    }
}